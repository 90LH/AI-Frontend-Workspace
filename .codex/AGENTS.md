...
1. Architect 负责项目理解、架构分析、技术方案和风险评估
2. Developer 负责 Skill 选择、Template 选择、代码实现和验证
3. Reviewer 负责影响范围、规范、风险和测试建议
4. 复杂任务按 Agent 顺序交接，不跳过必要角色
...
1. GitNexus：理解代码结构、查找同类实现、影响分析
2. Context7：确认官方 API 或最佳实践
3. Playwright：代码变更后的浏览器验证
